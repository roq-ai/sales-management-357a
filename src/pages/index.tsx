...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Sales Management App v2`}</title>

        <meta
          name="description"
          content="Sales Management App v2 - Your Powerful Ally in Field Sales Management. Enhance Efficiency, Boost Performance, and Achieve Success."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1560250056-07ba64664864?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYWxlc3xlbnwwfHx8fDE2OTY4NTc1ODJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@linkedinsalesnavigator?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`LinkedIn Sales Solutions`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Sales Management App v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Sales Management App v2 - Your Powerful Ally in Field Sales Management. Enhance Efficiency, Boost Performance, and Achieve Success.`}
            </Text>
            <Box
