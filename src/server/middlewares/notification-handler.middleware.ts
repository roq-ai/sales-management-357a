...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Sales Representative.create': {
    roles: ['business-owner', 'sales-manager', 'sales-analyst'],
    key: 'sale',
    tenantPath: [],
    userPath: [],
  },
  'Guest.create': { roles: ['business-owner', 'sales-manager'], key: 'complaint', tenantPath: [], userPath: [] },
  'Sales Manager.update': {
    roles: ['business-owner', 'sales-representative', 'sales-analyst'],
    key: 'target',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'sales-manager', 'sales-representative', 'sales-analyst', 'customer'];
